...
4. Part 3/4 (リスニングスナイプ): q には設問文（Who is...等）ではなく、必ず「読み上げられる音声スクリプトの本文（冒頭1文）」を入れること（例: "Attention passengers on the downtown..."）。この音声を聞いた瞬間にパラフレーズされた正解の選択肢を選ばせる問題（4択）
